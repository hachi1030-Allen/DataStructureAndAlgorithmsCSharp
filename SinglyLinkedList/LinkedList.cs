namespace SinglyLinkedList
{
    public class LinkedList<T> : System.Collections.Generic.ICollection<T>
    {
        ...
        public void AddFirst(LinkedListNode<T> node)
        {
            ...
            //Point Header to the new node from parameter.
            Head = node;
        ...
        /// <returns>True if the item is found, falses otherwise</returns>
        ...
        public bool Remove(T item)
        {
            ...
            // 3: Many nodes
            //    a: note to remove is the first node
            ...
            while ( current != null )
            {
                if (current.Value.Equals(item))
                {
                    ...
                    {
                        // case 3b
                        // This is the remove action. We are skipping over the current node as the remove.
                        // Before: Head -> 3 -> 5 -> 7
                        // We are removing 5 assume
                        // After: Head -> 3 ------> 7
        ...
        /// <summary>
        /// None generic version for Enumrates over the linked list values from Head to Tail
        /// </summary>
        /// <returns>A Head to Tail enumerator</returns>
        ...
        /// Thanks to GC, we do not have to do so much things to free the memory
        /// </summary>
        public void Clear()
        {
            Head = null;
